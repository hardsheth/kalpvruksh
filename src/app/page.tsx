...
export default function Home() {
  ...
  return (
   <div className="container-fluid">
    <div className="row">
    <img src="/IMG-20240818-WA0011.jpg" alt="some Random Image" className={styles.bannerimg} />
    </div>
    <div className="row row-cols-3 mt-2">
      <div className="col relative-position">
      <img src="IMG-20240818-WA0015.jpg" alt="some Random Image" className={`${styles.sideimg} animated-right`} />
      </div>
      <div className="col">
      ...
      <div className="col relative-position">
      <img src="/IMG-20240818-WA0007.jpg" alt="some Random Image" className={`${styles.sideimg} animated-left`} />
      </div>
    </div>
   </div>
  );
